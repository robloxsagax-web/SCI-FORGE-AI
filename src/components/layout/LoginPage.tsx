        ...
        >
          ...
          <div className="bg-[#111111] border border-white/5 rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 shadow-2xl">
            ...
            <motion.button
              ...
              className="w-full py-3.5 px-6 rounded-xl bg-white text-[#1f1f1f] font-semibold flex items-center justify-center gap-3 shadow-lg hover:shadow-xl transition-all duration-300"
            >
