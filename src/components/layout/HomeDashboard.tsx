      ...
      >
        ...
        >
          {stats.map((stat, idx) => (
            ...
            >
              <div 
                className="w-16 h-16 lg:w-20 lg:h-20 rounded-xl flex items-center justify-center transition-all duration-300 group-hover:scale-110 group-hover:brightness-110"
